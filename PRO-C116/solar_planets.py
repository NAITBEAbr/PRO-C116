...
cv2.putText(img, "Sol", (100,80), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255))
...
cv2.putText(img, "Urano", (950, 140), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 255))
